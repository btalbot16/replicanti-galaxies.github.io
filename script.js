...
function tickspeedR(){
	console.log((Decimal.pow(matter.log(4),0.4).div(100)).mul(tickspeed))
}
...
a("amount").onclick = function(){
	if(matterOnPrestige.floor().eq(0) && replicanti.lt(35)){alert("You need atleast 35 replicanti to prestige!")} else {
